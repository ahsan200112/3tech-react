...
const DigitalOptimizationFaqs = () => {
    ...
    const toggleFAQ = (index) => {
        ...
        trackEvent('click on Digital Optimization Faq question', 'FAQ Interaction', 'Click', `FAQ ${index + 1} ${openIndex === index ? 'Closed' : 'Opened'}`);
    };
    ...
    const fetchFaq = async () => {
        try {
            ...
            const filteredFaqs = allFaqs.filter(faq => faq.category === "digital optimization");
...
export default DigitalOptimizationFaqs; 