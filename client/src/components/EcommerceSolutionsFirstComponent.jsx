...
const EcommerceSolutionsFirstComponent = () => {
            ...
            <section >
                <div className="container pt-5" data-aos="fade-down"data-aos-delay="200">
                    <div className="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 className="o-hlo" style={{ borderBottom: "2px solid" }}>{t("E-Commerce Solutions")}</h2>
                            <h4 className="o-a d-flex align-items-center" style={{ gap: "8px" }}>
                                ...
                                > {t("Home")} </a> / {t("E-Commerce Solutions")}
                            </h4>
                        </div>
...
export default EcommerceSolutionsFirstComponent;
