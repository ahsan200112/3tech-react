...
const EcommerceSolutionFaqs = () => {
    ...
    const toggleFAQ = (index) => {
        ...
        trackEvent('click on Ecommerce Solutions Faq question', 'FAQ Interaction', 'Click', `FAQ ${index + 1} ${openIndex === index ? 'Closed' : 'Opened'}`);
    };
    ...
    const fetchFaq = async () => {
        try {
            ...
            const filteredFaqs = allFaqs.filter(faq => faq.category === "ecommerce solutions");
...
export default EcommerceSolutionFaqs; 