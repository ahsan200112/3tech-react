...
const CreativeDesignFaqs = () => {
    ...
    const toggleFAQ = (index) => {
        ...
        trackEvent('click on Creative Design Faq question', 'FAQ Interaction', 'Click', `FAQ ${index + 1} ${openIndex === index ? 'Closed' : 'Opened'}`);
    };
    ...
    const fetchFaq = async () => {
        try {
            ...
            const filteredFaqs = allFaqs.filter(faq => faq.category === "creative design");
...
export default CreativeDesignFaqs; 