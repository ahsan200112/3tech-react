...
const MobileApplicationsFaqs = () => {
    ...
    const toggleFAQ = (index) => {
        ...
        trackEvent('click on Mobile Applications Faq question', 'FAQ Interaction', 'Click', `FAQ ${index + 1} ${openIndex === index ? 'Closed' : 'Opened'}`);
    };
    ...
    const fetchFaq = async () => {
        try {
            ...
            const filteredFaqs = allFaqs.filter(faq => faq.category === "mobile applications");
...
export default MobileApplicationsFaqs; 