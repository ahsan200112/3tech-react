...
const PackagesFormFirstComponent = () => {
            ...
            <section>
                <div className="container pt-5" data-aos="fade-down"data-aos-delay="200">
                    <div className="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 className="o-hlo" style={{ borderBottom: "2px solid" }}>{t("Packages Form")}</h2>
...
export default PackagesFormFirstComponent;
