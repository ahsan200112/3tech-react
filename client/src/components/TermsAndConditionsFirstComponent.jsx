...
const TermsAndConditionsFirstComponent = () => {
    ...
    return (
        <div className="while-valu color-effect-firstC">
            <section >
                <div className="container pt-5" data-aos="fade-down"data-aos-delay="200">
                    <div className="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 className="o-hlo" style={{ borderBottom: "2px solid" }}>{t("Terms and Conditions")}</h2>
                            <h4 className="o-a d-flex align-items-center" style={{ gap: "8px" }}>
                                <i className="bi bi-house-door"></i>
                                <a href="/" style={{ textDecoration: "none", color: "inherit" }}
                                    onClick={() => trackEvent('click on link','Navigation', 'Click', 'Home Link')}  // Track event
                                >
                                    {t("Home")}
...
export default TermsAndConditionsFirstComponent;
